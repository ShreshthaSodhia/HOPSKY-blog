<?php
    ...
    //get signup form data when submit is clicked
    if(isset($_POST['submit'])){
        ...
        elseif(strlen($createpassword)<8 || strlen($confirmpassword)<8){
            $_SESSION['signup']='Password should be of atleast 8 characters';
        }
        elseif(!$avatar['name']){
                ...
                if(mysqli_num_rows($user_check_result)>0){
                    ...
                    if(in_array($extention,$allowed_files)){
                        ...
                        if($avatar['size']<1000000){
                            ...
                            $_SESSION['signup']='File size exceeds 1mb';
                        }
                    }
                    else{
        ...
        if(isset($_SESSION['signup'])){
            ...
            if(!mysqli_errno(($connection))){
                //redirect to login page w success
        ...
        //if button wasnt clicked then bounce back to signup
        header('location: '. ROOT_URL .'signup.php');
        die();
    }